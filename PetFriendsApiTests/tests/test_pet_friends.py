...
def test_post_add_new_pet_valid_key(name='Mynton', animal_type='camel', age='5', pet_photo='images/soft.jpg'):
...
def test_put_update_pet_with_id(name='Минтон', animal_type='верблюд', age=6):
    _, auth_key = pf.get_api_key(valid_email, valid_password)
